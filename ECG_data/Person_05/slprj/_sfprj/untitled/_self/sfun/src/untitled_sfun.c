  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(instanceChksum, "speT45VBbCExN9y26CVluYC") == 0) {
     ...
     case 6:
      {
        if (strcmp(instanceChksum, "s2uozG1AkCqci0m4ZR8f7rB") == 0) {
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(tpChksum, "speT45VBbCExN9y26CVluYC") == 0) {
     ...
     case 6:
      {
        if (strcmp(tpChksum, "s2uozG1AkCqci0m4ZR8f7rB") == 0) {
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 6:
      {
        if (strcmp(tpChksum, "s2uozG1AkCqci0m4ZR8f7rB") == 0) {
          extern mxArray *sf_c6_untitled_jit_fallback_info(void);
          plhs[0] = sf_c6_untitled_jit_fallback_info();
          break;
        }
      }
     ...
     case 3:
      {
        if (strcmp(tpChksum, "speT45VBbCExN9y26CVluYC") == 0) {
          ...
          const char* encoded_post_codegen_info =
            sf_c3_untitled_get_post_codegen_info();
     ...
     case 6:
      {
        if (strcmp(tpChksum, "s2uozG1AkCqci0m4ZR8f7rB") == 0) {
          ...
          const char* encoded_post_codegen_info =
            sf_c6_untitled_get_post_codegen_info();
          plhs[0] = sf_mex_decode(encoded_post_codegen_info);
          break;
        }
      }
